...
namespace Elemendid_vormis_TARpv23
{
    ...
    {
        List<string> elemendid = new List<string> { "Nupp", "Silt", "Pilt", "Mдrkeruut", "Raadionupp", "Tekstikast", "Loetelu", "Tabel", "Dialoogi aknad", "TeineVorm", "Picture_Viewer" };
        ...
        private void Tree_AfterSelect(object? sender, TreeViewEventArgs e)
        {
            ...
            {
                // Создаем первую кнопку для открытия формы TeineVorm
                Button btnTeineVorm = new Button();
                btnTeineVorm.Text = "Open TeineVorm";
                btnTeineVorm.Size = new Size(150, 30);
                btnTeineVorm.Location = new Point(150, 500); // Установите нужные координаты
                btnTeineVorm.Click += BtnTeineVorm_Click;
                Controls.Add(btnTeineVorm);

                // Создаем вторую кнопку для открытия формы Picture_Viewer
                Button btnPictureViewer = new Button();
                btnPictureViewer.Text = "Open Picture Viewer";
                btnPictureViewer.Size = new Size(150, 30);
                btnPictureViewer.Location = new Point(150, 540); // Установите нужные координаты
                btnPictureViewer.Click += BtnPictureViewer_Click;
        ...
        private void BtnTeineVorm_Click(object? sender, EventArgs e)
        {
            TeineVorm teineVorm = new TeineVorm(200, 200); // Инициализируем и показываем форму TeineVorm
            teineVorm.Show();
        }

        // Обработчик события для кнопки открытия Picture Viewer
        private void BtnPictureViewer_Click(object? sender, EventArgs e)
        {
            Picture_Viewer pictureViewer = new Picture_Viewer(400, 400); // Инициализируем и показываем форму Picture_Viewer
            pictureViewer.Show();
        }
